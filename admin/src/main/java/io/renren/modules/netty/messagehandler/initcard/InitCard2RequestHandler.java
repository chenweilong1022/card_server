...
import io.renren.modules.netty.message.initcard.InitCard2Request;
...
@Component
@Order(100)
public class InitCard2RequestHandler implements MessageHandler<InitCard2Request> {
    ...
    @Override
    public void execute(Channel channel, InitCard2Request message) {
